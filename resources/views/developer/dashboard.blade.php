      ...
      <div class="col-md-2 mb-1">
        <div class="admin-nav-box">
          ...
          <div class="admin-navs">
            ...
            <a href="{{ route('stores') }}" class="admin-nav-link"><i class="fas fa-store"></i>&nbsp;&nbsp;Stores</a>
            <a href="{{ route('developerPreferences') }}" class="admin-nav-link"><i class="fas fa-sliders-h"></i>&nbsp;&nbsp;Preferences</a>
          </div>
        </div>
      </div>
